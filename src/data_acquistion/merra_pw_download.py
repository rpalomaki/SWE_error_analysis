...
def get_merra_name(year, month, day):
    return f'MERRA2_400.inst1_2d_int_Nx.{year}{month:02d}{day:02d}.nc4'

def download_merra(year, month, day, output_dir):
    """
    ...
    filename = get_merra_name(year, month, day)
    https_fp = urljoin(main_https, f'{year:04d}/{month:02d}/{filename}')
    ...
    for year in range(2016, 2026):
        ...
        for month in range(1, 13):
            for day in range(1, 32):
                download_merra(year, month, day, '/Users/rdcrlzh1/Documents/SWE_error_analysis/local/pw')
